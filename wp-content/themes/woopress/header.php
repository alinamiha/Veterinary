...
<head>
    ...
    <meta name="google-site-verification" content="PCn-zTwQI2bKvoi-zScUwP2NMeQeodY4IMmJd8N501s" />
    ...
    <script data-ad-client="ca-pub-7957343974107825" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
    <link rel="icon" href="<?php echo et_get_favicon(); ?>" type="image/x-icon" />
    <link rel="shortcut icon" href="<?php echo et_get_favicon(); ?>" type="image/x-icon" />
	<title><?php wp_title( '|', true, 'right' );?></title>
    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-160962574-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-160962574-1');
    </script>
